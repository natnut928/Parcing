# https://hh.ru/search/vacancy? clusters=true & area=1 & ored_clusters=true & enable_snippets=true & salary= & text=sql
...
def vacancy_collection(name_collection, name_vacancy):
    try:
        name_collection.insert_one(name_vacancy)
    except dk:
        print(f"Вакансия с id {name_vacancy['_id']} уже занесена в базу")
